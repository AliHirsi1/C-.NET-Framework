...
namespace CarDealarship.UI.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        {
            return View(new ChangePasswordVMs());
        }



        [HttpPost]
        public ActionResult ChangePassword(ChangePasswordVMs password)
        {
            if (password.NewPassword == password.NewPasswordConfirm)
            {
                var usr = new UserManager<Users>(new UserStore<Users>(context));

                usr.ChangePassword(User.Identity.GetUserId(), password.OldPassword, password.NewPassword);
