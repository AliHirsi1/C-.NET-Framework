...
$('.details').hide();
$('#SalessearchButton').on('click', function () {
    var prams = {
    ...
    $.ajax({
        ...
        url: 'http://localhost:50163/api/SearchSales/Sales/',
        type: 'POST',
        ...
        success: function (vehicles) {
            ...
            $.each(vehicles, function (index, value) {
                ...
                output += '<td><strong>' + 'Sales Price:' + '</strong>' + ' $' + value.SalesPrice + '<br/>'
                    ...
                    + '<a class="btn btn-default" href="/Home/Purchase?id=' + value.VehicleId + '">Purchase</a></td></tr></table></div></div>'
            });

            $('#salesSearchResult').html(output);
        },
...
function Purchase(id) {
    ...
    $.ajax({
        url: 'http://localhost:50163/api/Home/Purchase' + id,
        type: 'POST',
        success: function (value) {
            ...
            $('#salesSearchDetails').html(output);
        }
